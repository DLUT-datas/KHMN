...
def seed_MS2toList(file_path,mgf_name):
    ...
    # mgf_name =  'BOAs_Database_Negative.mgf'
    MS2List=[]
...
# weight = feature_mz
# rt = feature_rt
# MS2weight = MS2List_mz
# MS2rt = MS2List_rt
# MS2_mgf = MS2List_mgf
# delata_weight = mz_threshold
    candidate_MS2id=[]
    MS2List=[]
...
# Import all '.mgf' files, Feature matching and filter, Output new '.mgf' files
    
filePath = 'D:\\Python_code\\script_code\\mgf_file\\'
...
#    name = mfg_all_name[0]
    MS2List = []
    MS2List=seed_MS2toList(filePath,name)
    ...
    output_mgf_file_name = output_mgf_file_path+'filter_' + name
...
print('Generate new .mgf file Finished')  
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
